...
class AppointmentBooking {
	...
	void dataAdd() //for creating Default doctor list present in the database.
	{
		doctorName.add("Tejaswi Tyagi");
		doctorName.add("Ankush Nag");
		doctorName.add("Prashant Jha");
		doctorName.add("Ashish Gadpayle");
		doctorName.add("Sandip Paul");
		doctorName.add("Himanshi Pokhle");
		...
		doctorMobileNumber.add(9289413157l);
	...
	void admin() throws Exception {
		...
		while (flag) {
			new ProcessBuilder("cmd", "/c", "cls").inheritIO().start().waitFor(); //clearing the console
...
//			break;
	...
	public static void main(String[] args) throws Exception {
		...
		while (flag = true) {
			...
			System.out.println("------------------------------------------------------------------------------------------------------");
			System.out.println( "\t\t            | WELCOME TO DOCTOR APPOINTMENT BOOKING PORTAL |");
			System.out.println("-------------------------------------------------------------------------------------------------------\n\n");
			System.out.println("The one-stop destination for booking the appointment with our specialists !!");
			System.out.println();
			Thread.sleep(800);
